        ...
        let neuron1₊Isyn = @inbounds(u[1]),
            ...
            let
                ...
                du[3] = (-1 * neuron1₊aₘ * neuron1₊leak₊g * (neuron1₊Vₘ + -1neuron1₊El) +
                         -1 * neuron1₊Kdr₊gbar * neuron1₊aₘ * neuron1₊Kdr₊n^4.0 *
                         (neuron1₊Vₘ + -1neuron1₊EK) +
                         -1 * neuron1₊NaV₊gbar * neuron1₊aₘ * neuron1₊NaV₊h *
                         neuron1₊NaV₊m^3.0 * (neuron1₊Vₘ + -1neuron1₊ENa) +
                ...
                du[8] = (-1 * Glut1₊gbar * Glut1₊s * (neuron2₊Vₘ + -1 * EGlut) +
                         ...
                         -1 * neuron2₊Kdr₊gbar * neuron2₊aₘ * neuron2₊Kdr₊n^4.0 *
                         (neuron2₊Vₘ + -1neuron2₊EK) +
                         -1 * neuron2₊NaV₊gbar * neuron2₊aₘ * neuron2₊NaV₊h *
                         neuron2₊NaV₊m^3.0 * (neuron2₊Vₘ + -1neuron2₊ENa) +
