...
function NaV₊τₕ(V)
    (1.34 / (1.0 + exp((V + 62.9) / -10.0))) * (1.5 + 1.0 / (1.0 + exp((V + 34.9) / 3.6)))
end
...
nav_kinetics = [Gate(SteadyStateTau, NaV₊m∞(Vₘ), NaV₊τₘ(Vₘ), p = 3, name = :m)
                Gate(SteadyStateTau, NaV₊h∞(Vₘ), NaV₊τₕ(Vₘ), name = :h)]
cas_kinetics = [Gate(SteadyStateTau, CaS₊m∞(Vₘ), CaS₊τₘ(Vₘ), p = 3, name = :m)
                Gate(SteadyStateTau, CaS₊h∞(Vₘ), CaS₊τₕ(Vₘ), name = :h)]

cat_kinetics = [Gate(SteadyStateTau, CaT₊m∞(Vₘ), CaT₊τₘ(Vₘ), p = 3, name = :m)
                Gate(SteadyStateTau, CaT₊h∞(Vₘ), CaT₊τₕ(Vₘ), name = :h)]

ka_kinetics = [Gate(SteadyStateTau, KA₊m∞(Vₘ), KA₊τₘ(Vₘ), p = 3, name = :m)
